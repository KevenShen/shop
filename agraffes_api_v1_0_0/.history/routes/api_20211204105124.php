...
use App\Http\Controllers\Admin\Ad\Subject\SubjectController;
...
use App\Http\Controllers\Admin\Ad\MediaVideo\MediaVideoController;
...
Route::group(['middleware' => 'auther'], function () {
    Route::Resources(
        [
            ...
            '/admin/adSubject' => SubjectController::class,
            ...
            '/admin/mediaSetting' => MediaVideoController::class,
        ]
    );
});
Route::Resources([
