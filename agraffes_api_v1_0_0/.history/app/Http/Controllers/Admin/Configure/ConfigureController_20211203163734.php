...
class ConfigureController extends Controller
{
    ...
    public function index()
    {
        ...
        if ($admin_user_data['admin_user_id'] === "" && $admin_user_data['admin_token'] === "") {
            ...
            if (($this->page && $this->size)) {
                $res['data']['configure'] = $this->repository->paginate($this->size, $this->page);
            } else {
                $res['data']['configure'] = $this->repository->all();
            }
        }
    ...
    public function update($id)
    {
        ...
        if ($admin_user_data['admin_user_id'] === "" && $admin_user_data['admin_token'] === "") {
            ...
            $res['data'] = Storage::putFile(DefaultPath, $this->request['shop_logo']);
            // dd($this->request['shop_logo']);
