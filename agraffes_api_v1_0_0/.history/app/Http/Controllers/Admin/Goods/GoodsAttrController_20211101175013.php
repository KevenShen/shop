...
namespace App\Http\Controllers\Admin\GoodsAttr;
...
class GoodsAttrController extends Controller
{
    ...
    public function __construct(Request $request, GoodsAttrRepository $goodsAttrRepository)
    {
        $this->repository = $goodsAttrRepository;
