...
class GoodsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($admin_user_data['admin_user_id'] === "" && $admin_user_data['admin_token'] === "") {
            ...
            $goods_data['goods_gallery'] = unset_Arr_col($filterData, 'goods_img', 9);
            $goods_data['goods_real_gallery'] = unset_Arr_col($filterData, 'goods_real_img', 14);
            ...
            return $goods_data['goods_gallery'];
        }
        $res['admin_token'] = $admin_user_data['admin_token'];
        return $res;
    }
