...
class User extends Authenticatable
{
    ...
    protected $fillable = array('aite_id', 'email', 'first_name', 'last_name', 'password', 'question', 'answer', 'sex', 'birthday', 'address_id', 'reg_time', 'last_login', 'last_time', 'last_ip', 'visit_count',  'salt', 'flag', 'alias', 'msn', 'office_phone', 'home_phone', 'mobile_phone', 'is_validated', 'passwd_question', 'passwd_answer', 'user_picture', 'old_user_picture', 'report_time');
   ...
   * @return  self
   */
  public function set salt($value)
  {
    $this-> salt = $value;
    return $this;
  }
