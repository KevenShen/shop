...
class AdMedia extends Model
{
    ...
    protected $fillable = array(
        'configure_id', 'media_video_url', 'media_video_link', 'media_video_playback_volume', 'media_video_review', 'media_video_desc', 'media_video_order', 'created_at', 'updated_at'
    );
    ...
    /**
     * Get the value of media_video_playback_volume
     */
    public function getMediaVideoPlaybackVolume()
    {
        return $this->media_video_playback_volume;
    }

    /**
     * Set the value of media_video_playback_volume
     * @return  self
     */
    public function setMediaVideoPlaybackVolume($value)
    {
        $this->media_video_playback_volume = $value;
        return $this;
    }
