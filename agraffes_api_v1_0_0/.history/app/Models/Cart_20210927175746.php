...
class Cart extends Model
{
    ...
    protected $fillable = array('user_id', 'session_id', 'goods_id', 'goods_sn', 'product_id', 'group_id', 'goods_name', 'market_price', 'goods_price', 'goods_number', 'is_real', 'extension_code', 'parent_id', 'rec_type', 'model_attr', 'ru_id', 'add_time', 'tid', 'take_time', 'is_checked', 'is_invalid');
