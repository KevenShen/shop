...
class User extends Authenticatable
{
    ...
    protected $fillable = array('configure_id', 'report_time', 'email', 'first_name', 'last_name', 'password', 'question', 'answer', 'sex', 'birthday', 'address_id', 'last_login', 'last_time', 'last_ip', 'visit_count', 'token', 'flag', 'alias', 'msn', 'office_phone', 'home_phone', 'mobile_phone', 'is_validated', 'passwd_question', 'passwd_answer', 'old_user_picture', 'created_at', 'updated_at');
