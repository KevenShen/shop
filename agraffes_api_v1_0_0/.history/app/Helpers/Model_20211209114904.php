...
$t_arr = [
    "goods_attr_0_attr_value" => "11",
    "goods_attr_0_attr_price" => "11",
    "goods_attr_0_attr_sort" => "11",
    "goods_attr_1_attr_value" => "22",
    "goods_attr_1_attr_price" => "22",
    "goods_attr_1_attr_sort" => "22",
    "goods_attr_0_attr_img" => [],
    "goods_attr_1_attr_img" => []
];

var_dump(str_Reg_filter($t_arr, ['goods_attr']));
