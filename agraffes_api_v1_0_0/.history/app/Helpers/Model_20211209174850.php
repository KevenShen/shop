...
function agg_arr($arrData, $arr, $handle)
{
    foreach ($arrData as $key => $value) {
        foreach ($arr as $val) {
            if (strstr($key, $val)) {
                $data[substr($key, 11, 1)][$val] = $value;
                $data[substr($key, 11, 1)]['handle'] = $handle;
            }
        }
    }
    return $data;
...
// $t_arr = [
//     "goods_attr_0_attr_value" => "33",
//     "goods_attr_0_attr_price" => "33",
//     "goods_attr_0_attr_sort" => "33",
//     "goods_attr_1_attr_value" => "44",
//     "goods_attr_1_attr_price" => "44",
//     "goods_attr_1_attr_sort" => "44",
//     "goods_attr_0_attr_img" => 2,
//     "goods_attr_1_attr_img" => 2
// ];

// var_dump(agg_arr($t_arr, ["attr_value", "attr_price", "attr_sort", "attr_img"]));
