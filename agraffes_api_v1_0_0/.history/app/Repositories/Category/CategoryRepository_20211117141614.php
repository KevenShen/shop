...
class CategoryRepository
{
    ...
    public function getCategoryGetGoods($id)
    {
        ...
        $goodsByCollection = DB::table('category_group')->join("goods", "category_group.handle", "=", "goods.handle")
            ->select("category_group.id")->where("category_group.cat_link", "=", $id)->get()->toArray();
