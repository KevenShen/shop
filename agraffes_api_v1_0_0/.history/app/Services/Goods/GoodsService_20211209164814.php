...
class GoodsService
{
    ...
    public function createGoods($data, $handle)
    {
        ...
        $goods_img=$this->goodsGalleryRepository->batchCreateGoodGallery();
        ...
        foreach ($goods_category_group as $key => $value) {
            $goods_category_group_data[$key]['handle'] = $handle;
            $goods_category_group_data[$key]['cat_id'] = $value;
        }
        // $this->goodsRepository->create()
        return $goods_real_gallery_data;
    }
}
