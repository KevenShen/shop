...
class GoodsService
{
    ...
    public function createGoods($data, $handle)
    {
        ...
        $goods_group_collection_data = agg_arr($goods_group_collection, ["cat_id"], 15, $handle);
        $create_goods_attr = $this->categoryGroupRepository->batchCreateGroupCollection($goods_group_collection_data);
