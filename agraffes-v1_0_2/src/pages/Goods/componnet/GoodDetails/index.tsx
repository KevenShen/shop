...
import { Box, Typography, Form, Button, Icon, Table, Select } from '@alifd/next';
...
const render = (value, index, record) => {
  return <Link to="/">({record.num})</Link>;
}
            ...
            <Box>
              <Form className={styles.smart_payment_enabled}>
                <Box direction="column">
                  <Box>
                    <fieldset className={styles.form_options}>
                      <legend className={styles.option_header}>
                        <span className={styles.option_name}>Quantity & Price(c)</span>
                      </legend>
                      <Table dataSource={dataSource()}>
                        <Column dataIndex="num" cell={render}></Column>
                        <Column dataIndex="basePrice"></Column>
                      </Table>
                    </fieldset>
                  ...
                  <Box>
                    <fieldset className={styles.form_options}>
                      ...
                      <Box className={styles.option_value}>

                      </Box>
                    </fieldset>
                  </Box>
                  <Box className={styles.product_form_atc} direction="column">
                    <Box className={styles.roduct_form_atc_qty}>
                      ...
                      <Box>
                        <Button className={styles.product_form_atc_button}>
                          Add to cart
                        </Button>
                      </Box>
                    </Box>
                  </Box>
                  <Box className={styles.payment_button}>
                    <Box className={styles.shopify_cleanslate}>
                      <Button className={styles.shopify_payment_button_button}>Buy it now</Button>
                    </Box>
                  </Box>
                </Box>
              </Form>
              <Box className={styles.share_buttons}>
                <span className={styles.share_buttons_title}>Share this:</span>
                <Box className={styles.share_buttons_list}>
                  <Link to="/" className={styles.share_buttons_button}>
                    facebook
                  </Link>
                  <Link to="/" className={styles.share_buttons_button}>
                    facebook
