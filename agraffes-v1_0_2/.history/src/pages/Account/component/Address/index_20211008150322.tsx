...
import { Box, Typography, List, Input, Button, Select } from '@alifd/next';
            ...
            <Box className={styles.account_page_column_half}>
              <Box className={styles.account_address_form}>
                ...
                <Box className={styles.form_fields_columns} direction="row">
                  ...
                  <Box className={styles.form_field}><Input placeholder="Country" className={styles.form_field_input} /></Box>
                </Box>
                <Box className={styles.form_fields_columns} direction="row">
                  <Box className={styles.form_field}><Select placeholder="State/Province" className={styles.form_field_input} style={{border:0}}/></Box>
