...
import { Box, Typography, Form, Button } from '@alifd/next';
              ...
              <Button className={styles.product_gallery_expand}>
                ...
                <figure className={styles.product_gallery_media}>
                  <Box className={styles.product_gallery_image_background}>
                    <img src="https://cdn.shopifycdn.net/s/files/1/0528/5888/0181/products/CAOM_2_1000x1000.jpg?v=1630571990" alt="" />
                  </Box>
                </figure>
              </Button>
            </Box>
