    ...
    <Box>
      <Box >
        <Box className={styles.site_footer_item} direction="row" wrap>
          <Collapse defaultExpandedKeys={["one"]} className={classnames(styles.site_footer_blocks, styles.site_footer_block_menu)}>
            <Panel title="Main-menu" key="one">
              <CateGoryFooter dataSource={dataSource} />
            </Panel>
          </Collapse>
          <Collapse defaultExpandedKeys={["two"]} className={classnames(styles.site_footer_blocks, styles.site_footer_block_social_accounts)}>
