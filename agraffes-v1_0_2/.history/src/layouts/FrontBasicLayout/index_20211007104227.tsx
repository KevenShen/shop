...
import { Box, ConfigProvider, ResponsiveGrid } from '@alifd/next';
  ...
  return (
    <ConfigProvider device={device}>
      <ResponsiveGrid device="desktop">
        <Cell colSpan={12}>
          <Box justify="center">
            <Box>            <Box><Logo image={globalState.global.logoImgUrl} url={globalState.global.logoUrl} /></Box>
              <Box><GlobalSearch /></Box></Box>
        ...
        {/* <Box className={styles.site_header} direction="column">
          <Box className={styles.section_static_header}>
            <Box justify="center" className={styles.site_header_main}>
