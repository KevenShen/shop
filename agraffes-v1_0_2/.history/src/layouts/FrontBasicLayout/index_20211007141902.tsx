...
export default function FrontBasicLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <ConfigProvider device={device}>
      ...
      {/* <Box direction="column">
        ...
        <Box>{children}</Box>
        <Box><Footer dataSource={globalState.dataSource} copyright={globalState.copyright} /></Box>
      </Box> */}
